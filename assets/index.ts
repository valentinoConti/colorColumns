...
import unsorted from "./unsorted.png";
...
const unsortedImg = unsorted as string;
const sortedImg = sorted as string;
const autoClickOn = on as string;
const autoClickOff = off as string;

export { playerHappy, playerMidHappy, playerWorried, playerSad, playerDead, unsortedImg, sortedImg, autoClickOn, autoClickOff };
